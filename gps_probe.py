...
class gps_probe(gr.sync_block):
    ...
    def handler(self, pdu):
        ...
        try:
            ...
            gps_location = subprocess.Popen(["gpspipe", "-w", "-o", "-t", "|", "grep", "-m", "1", "lon"],stdout=PIPE)
        ...
        #pprint.pprint(d);
        ometa.update( d )
        self.message_port_pub(pmt.intern("pdus"), pmt.cons(pmt.to_pmt(ometa), data), pmt.intern("gps_location"))
